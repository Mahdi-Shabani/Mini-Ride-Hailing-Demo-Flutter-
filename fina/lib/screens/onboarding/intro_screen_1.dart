...
const double _kOverlayRatio = 585 / 812; // ≈ 0.720
...
const double _kMinSwipeVelocity = 240;
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onHorizontalDragEnd: (details) {
        if (details.velocity.pixelsPerSecond.dx < -_kMinSwipeVelocity) {
          Navigator.of(
            context,
          ).pushReplacement(_slideLeftRoute(const IntroScreen2()));
        }
      },
      child: Scaffold(
        body: Stack(
